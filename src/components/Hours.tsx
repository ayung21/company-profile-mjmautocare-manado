      ...
      <div className="container">
        ...
        <div className="hours-wrapper">
          <div className="hours-card">
            <div className="hours-time-slots">
              <div className="hours-slot">
                ...
                <div>
                  <div className="hours-slot-label">Cuci & Salon</div>
                  <div className="hours-main-time">08:00 – 18:00</div>
                  <div className="hours-timezone">WITA</div>
                </div>
              </div>
              <div className="hours-slot-divider" />
              <div className="hours-slot">
                <div className="hours-clock-icon">
                  <svg
                    width="32"
                ...
                <div>
                  <div className="hours-slot-label">Service</div>
                  <div className="hours-main-time">09:00 – 18:00</div>
                  <div className="hours-timezone">WITA</div>
                </div>
              </div>
            </div>
            ...
            <ul className="schedule-list">
              {schedule.map((item) => {
                ...
                return (
                  <li
                    key={item.day}
                    className={`schedule-row${isToday ? " today" : ""}${!item.open ? " closed" : ""}`}
                  >
                    ...
                    <span className="schedule-status">
                      {item.open ? (
                        <span className="schedule-status-multi">
                          <span className="schedule-status-row">
                            <span className="status-dot open" />
                            <span className="status-type">Cuci & Salon</span>
                            <span className="status-time">08:00 – 18:00</span>
                          </span>
                          <span className="schedule-status-row">
                            <span className="status-dot open" />
                            <span className="status-type">Service</span>
                            <span className="status-time">09:00 – 18:00</span>
                          </span>
                        </span>
                      ) : (
                        <span className="schedule-status">
        ...
        <div className="hours-note">
          ...
          Untuk reservasi atau pertanyaan di luar jam operasional, silakan
          hubungi kami via{" "}
          <a
