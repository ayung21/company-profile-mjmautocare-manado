    ...
    <section id="kontak" className="section contact-section">
      <div className="container">
        <div className="section-header">
          ...
          <h2>Temukan & <span>Hubungi Kami</span></h2>
          <p className="section-desc">
            Kami siap membantu kebutuhan kendaraan Anda
          </p>
        </div>
        ...
        <div className="contact-grid">
          ...
          <div className="contact-info">
            ...
            <div className="contact-card">
              ...
              <div>
                ...
                <p>
                  <a href="tel:+628884333311">0888 433 3311</a>
                </p>
              </div>
            </div>
            ...
            <div className="contact-wa-cta">
              <p>Pesan atau konsultasi gratis via WhatsApp</p>
              <div className="contact-wa-buttons">
                <a
          ...
          <div className="contact-map">
            <iframe
              ...
              title="Lokasi MJM AUTOCARE"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.4!2d124.84!3d1.47!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMcKwMjgnMTIuMCJOIDEyNMKwNTAnMjQuMCJF!5e0!3m2!1sid!2sid!4v1234567890"
              width="100%"
              height="450"
