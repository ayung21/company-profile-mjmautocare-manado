        ...
        <div className="contact-grid">
          ...
          <div className="contact-info">
            ...
            <div className="contact-card">
              ...
              <div>
                ...
                <p>
                  <a href="tel:+628114333331">0811 433 3331</a>
                  <br />
          ...
          <div className="contact-map">
            <div className="map-placeholder">
              ...
              <h4>MJM AUTOCARE</h4>
              <p>Jl. Pingkan Matindas No. 23<br />Paal Dua, Manado</p>
              <a
                href="https://maps.google.com/?q=Jl.+Pingkan+Matindas+No.+23+Paal+Dua+Manado"
                className="btn-maps"
                target="_blank"
                rel="noopener noreferrer"
              >
